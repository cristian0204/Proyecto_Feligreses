...
<div class="breadcome-area">
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">Tipo Documento</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                @if(Auth::User()->can('crearTipoDocumento')) 
                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                     Tipo Documento<a class="btn btn-success bnt-xs" href="#" data-toggle="modal" data-target="#PrimaryModalalert1">Agregar</a>
                 </div>
                 @endif
            </div>
         <br>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <table id="example" class="table table-striped table-bordered" style="width:100% ; margin: 1">
                    <thead>
                        ...
                        @if(Auth::User()->can('editarTipoDocumento'))
                       @if(Auth::User()->can('eliminarTipoDocumento')) 
                    ...
                    <tbody>
                        @foreach ($tipo as $tipo)
                            <tr>
                                ...
                                <th>
                                    @if(Auth::User()->can('eliminarTipoDocumento'))                                     
                                    <button class="fa fa-trash-o btn-danger btn-sm" type="submit" data-toggle="modal" data-target="" onclick="eliminar({{$tipo->id}})"></button> 
                                    @endif
                                    
                                    @if(Auth::User()->can('editarTipoDocumento'))
                                    <button class="fa fa-pencil-square-o  btn-info btn-sm" class="btn btn-success bnt-xs" href="#" data-toggle="modal" data-target="#Modal2" aria-hidden onclick="editar({{$tipo->id}})"></button>
                                    @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content" id="modal-content">
            ...
            <div class="modal-body">
                <center> <h4>Desea agregar otro tipo de Documento</h4>  </center>   
                <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-12">
                                <div class="form-group" style="text-align: left;">
                                    ...
                                    <input type="text" name="tipo" class="form-control" id="tipo" placeholder="Tipo De Documento" onkeypress="return soloLetras(event)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-12">
                                <div class="form-group" style="text-align: left;">
                                    ...
                                    <textarea name="desc" class="form-control" id="desc" placeholder="Descripción del documento" rows="5" style="resize: none;" onkeypress="return soloLetras(event)"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
...
<div id="Modal2" class="modal modal-edu-general default-popup-PrimaryModal fade" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content" id="modal-content">
            ...
            <div class="modal-body">
                    <center> <h4>Desea Editar el tipo de Documento</h4>  </center>   
                <div class="row">
                    ...
                    {{ csrf_field() }}   
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-12">
                                <div class="form-group" style="text-align: left;">
                                    <label for="nombre">Tipo De Documento</label>
                                    <input type="text" name="tipo1" class="form-control" id="tipo1" placeholder="Tipo De Documento" onkeypress="return soloLetras(event)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-12">
                                <div class="form-group" style="text-align: left;">
                                    <label for="nombre">Descripción del documento</label>
                                    <textarea name="desc1" class="form-control" id="desc1" placeholder="Descripción del documento" rows="5" style="resize: none;" onkeypress="return soloLetras(event)"></textarea>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content" id="modal-content">
            ...
            <div class="modal-body">
                    <center> <h4> Estás seguro? <br> <br> No podrás revertir esto! </h4>  </center>
                        <div class="col-lg-12">
                            <div class="col-lg-12">
                                 <form action="{{URL::to('/')}}/tipo/{{ $tipo->id }}" method="POST" id="frm_delete"> 
                                      {{ csrf_field() }}
                                      {{ method_field('DELETE') }}
                                      <input type="hidden" id="id_delete" value="{{ $tipo->id }}">
...
function guardar(){
        ...
        if(res!=""){
            ...
            $.ajax({
                type:"POST",
                url: "tipo/guardar",
                data: {nombre: $("#tipo").val(), descripcion: $("#desc").val(), _token: token},
                success: function(result)
                {
                    if(result=="1"){
                        swal("Error","Se Ha Presentado Un Error "+result,"error");                         
                     }else if(result==2){
                         swal("Ops","Este Tipo De Documento ya existe","info");
                     }
                     else{
        ...
        if(res!=""){
          ...
          var token = "<?=csrf_token(); ?>";
            $.ajax({
                type:"POST",
                url: "tipo/modificar",
                data: {nombre: $("#tipo1").val(), descripcion: $("#desc1").val(), _token: token, id:$("#id").val()},
...
function editar(id){     
        $.ajax({
                type:"get",
                url: "tipo/consultar/"+id,
                success: function(result){
                    $.each(result,function(i,item){
                        $("#tipo1").val(item.nombre);
...
function validarcampos(){
        var mensaje = '';
        if($("#tipo").val()==""){
            mensaje += '<br>Tipo De Documento';
        }
        if($("#desc").val()==""){
            mensaje += '<br>Descripción del documento';
        }  
        return mensaje;
}
